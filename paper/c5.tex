...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{../result/user-auth-admin.png}
    \caption{管理员认证和授权用例测试截图}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{../result/user-auth-emp.png}
    \caption{采摘员工认证和授权用例测试截图}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{../result/produce-predict.png}
