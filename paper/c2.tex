...
\begin{figure}
    \centering
    \includegraphics[height=0.5\textheight]{../design/out/Spring-Security.png}
...
基于 GTID 的主从复制技术是一种在数据库系统中广泛应用的重要技术，它在提高数据的可用性、可靠性和可扩展性方面发挥着关键作用，其主从复制的流程如图\ref{fig:GTID-Replication}所示，左侧为主库，右侧为从库，具体执行解释如下：
